    ...
    <div class="modal-dialog d-flex flex-column justify-content-center my-0" role="document">
        <div class="modal-content">
            ...
            @if (storagePercentage() == 100)
                ...
                <div class="d-flex flex-wrap justify-content-center align-items-center h-100 p-3">
                    <h4 class="text-center">You've reached the storage limit.<br>Delete some files to free up space.</h4>
                </div>
