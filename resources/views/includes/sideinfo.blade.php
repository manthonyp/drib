<div id="file-info" class="border-left p-3">
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="border-bottom-dark">Details</h3>
        <button class="file-hideinfo round-button dark text-dark d-flex justify-content-center" type="button" data-toggle="tooltip" data-placement="bottom" title="Close">
    ...
    <div class="audio-details">
        <div class="d-flex flex-column">
            <h5 class="mb-3 py-2 border-bottom ">General</h5>
            ...
            <h5 class="mb-3 py-2 border-bottom">File</h5>
            <div class="row mb-2">
