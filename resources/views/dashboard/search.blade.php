...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="page-title text-truncate mb-0">Search: {{$query}}</h1>
        <div class="d-flex align-items-center">

            @if ($count > 1)
                <h6 class="result-count rounded text-secondary border">{{$count}} items</h6>
            @elseif ($count == 1)
                <h6 class="result-count rounded text-secondary border">{{$count}} item</h6>
            @endif
