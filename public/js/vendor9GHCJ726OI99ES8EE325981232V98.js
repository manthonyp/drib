...
function togglePlayPauseIcon() {
    $('.wave-play-pause i').text($('.wave-play-pause i').text() == 'play_arrow' ? 'pause' : 'play_arrow');
}

// show loader while wavesurfer is loading
wavesurfer.on('loading', function () {
    $('.wavesurfer-audio .loader').show();
});

// hide loader when wavesurfer is ready
wavesurfer.on('ready', function () {
    $('.wavesurfer-audio .loader').hide();
});

// reset pause button to play on finish
wavesurfer.on('finish', function () {
    togglePlayPauseIcon();
});

// waveform audio play and pause
$('.wave-play-pause').click(function () {
    wavesurfer.playPause();
    togglePlayPauseIcon();
});

// waveform rewind
$('.wave-rewind').click(function () {
    wavesurfer.skipBackward();
});

// waveform fast forward
$('.wave-forward').click(function () {
